#!/usr/bin/env python3
"""
Standalone migration script for personality extraction fields.
Adds 3 columns to personality_profile, fixes extraction_source CHECK to include
'merged', changes UNIQUE constraint to (rider_id, profile_type, extraction_source),
and creates the personality_trait_evidence table.

Run: python3 migrations/apply_migration_012.py
...
def apply_migration():
    """Apply migration 012: personality extraction fields and evidence table."""
    print("=" * 70)
    print("Migration 012: Personality Extraction Fields")
    print("=" * 70)
    print()
    ...
    try:
        ...
        # Read the SQL file
        sql_file = Path(__file__).parent / '012_personality_extraction_fields.sql'
