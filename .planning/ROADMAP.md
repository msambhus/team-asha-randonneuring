...
| 10. Multi-Rider Strava Analysis | 2/2 | Code complete | 2026-03-25 |
...
- [x] 10-02-PLAN.md — Multi-rider template (summary table + per-rider accordion), admin-gate plan toggle, navigation links, human-verify checkpoint
