---
phase: 2
slug: stop-to-coordinate-interpolation
status: draft
...
|---------|------|------|-------------|-----------|-------------------|-------------|--------|
| 02-01-01 | 01 | 1 | WIND-05 | unit | `python3 -m pytest tests/test_weather.py::TestGetStopCoordinates -x` | ❌ W0 | ⬜ pending |
...
*Add class to existing `tests/test_weather.py` — no new files needed.*
