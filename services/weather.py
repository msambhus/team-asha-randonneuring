...
def _fetch_batch(batch_points):
    ...
    params = {
        'latitude': lats,
        'longitude': lngs,
        'hourly': 'temperature_2m,apparent_temperature,wind_speed_10m,wind_gusts_10m,wind_direction_10m,precipitation_probability,precipitation,cloud_cover,weather_code',
        'timezone': 'auto',
    }
